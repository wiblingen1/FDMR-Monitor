<nav class="main-header navbar navbar-expand-md navbar-light navbar-dark text-sm">
    <div class="container">
        <a href="#" class="navbar-brand">
            <img src="img/Logo_mini.png" alt="FreeDMR Portugal" class="brand-image img-circle elevation-3"
                style="opacity: .8">
        ...
        <div class="collapse navbar-collapse order-3" id="navbarCollapse">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a href="?p=home" class="nav-link" id="nav_dash"></a>
                </li>
                <li class="nav-item">
                    <a href="?p=systems" class="nav-link" id="nav_lnksys"></a>
                </li>
                <li class="nav-item">
                    <a href="?p=systemstg" class="nav-link" id="nav_statg"></a>
                </li>
                <li class="nav-item">
                    <a href="?p=openbridge" class="nav-link" id="nav_opb"></a>
                </li>
                <li class="nav-item">
                    <a href="?p=toptg" class="nav-link" id="nav_tptg"></a>
                </li>
                <li class="nav-item">
                    <a href="?p=monitor" class="nav-link" id="nav_mon"></a>
                </li>
                <li class="nav-item dropdown dropdown-hover">
                    ...
                    <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                        <li>
                            <a href="?p=calc" class="dropdown-item" id="nav_calc"></a>
                        </li>
                        <li>
                            <a href="?p=wwtg" class="dropdown-item" id="nav_tglst"></a>
                        </li>
                        <li>
